...
class LoginViewModel(
    ...
    val launchMain = MutableLiveData<Event<Map<String, String>>>()

    val emailField: MutableLiveData<String> = MutableLiveData()
    val passwordField: MutableLiveData<String> = MutableLiveData()
    val loggingIn: MutableLiveData<Boolean> = MutableLiveData()
    val signUpTv: MutableLiveData<Event<Map<String, String>>> = MutableLiveData()
    ...
    fun onClickSignUpTv(event: Event<Map<String, String>>) = signUpTv.postValue(event)
}